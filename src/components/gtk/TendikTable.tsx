...
export default function TendikTable({ onSelectionChange, searchTerm, completenessFilter, itemsPerPage }: TendikTableProps) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setLoading(true);
      try {
        const result = await dapodikService.getGTK(itemsPerPage, searchTerm, currentPage, 'tendik', 'aktif', completenessFilter);
            ...
            <div className="flex gap-3 justify-end pt-2 border-t border-gray-100 dark:border-gray-800">
              ...
              <Button 
                ...
                onClick={() => {
                  ...
                  navigate(`/${role}/gtk-data/edit/${selectedItemForCompleteness.ptk_id}?tab=tendik`);
                }}
              >
                Lengkapi Data
              </Button>
