...
export default function UserDropdown() {
  ...
  const fotoUrl = profilePhoto 
    ? getFotoUrl(profilePhoto) 
    : (user && (user as any).foto ? getFotoUrl((user as any).foto) : "/images/default/profile.jpg");
    ...
    <div className="relative">
      ...
      >
        <span className="mr-3 overflow-hidden rounded-full h-11 w-11">
          <img src={fotoUrl} alt="User" className="h-full w-full object-cover object-top" />
        </span>
