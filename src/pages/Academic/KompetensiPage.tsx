...
import KompetensiTable from "../../components/academic/KompetensiTable";
...
export default function KompetensiPage() {
  ...
  return (
    <>
      <PageMeta
        title="SIMAK | Kompetensi Keahlian"
        description="Halaman pengelolaan data kompetensi keahlian sekolah"
      />
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6 no-print">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
              Kelola daftar program keahlian dan jurusan yang tersedia di sekolah.
            </p>
          </div>
        </div>
