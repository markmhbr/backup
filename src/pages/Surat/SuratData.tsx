...
const SuratData: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Search & Filters */}
      {['masuk', 'keluar', 'arsip'].includes(currentTab) && (
        <div className="flex flex-col md:flex-row gap-4 bg-gray-50 dark:bg-gray-800/50 p-4 rounded-xl border border-gray-200 dark:border-gray-800">
          <div className="flex-1 relative">
            <input
              type="text"
              placeholder="Cari perihal, nomor surat, nomor agenda, atau asal..."
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
              className="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-900 text-gray-900 dark:text-white focus:outline-none focus:border-brand-500"
            />
