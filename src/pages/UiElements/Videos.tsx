...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | SIMAK - React.js Admin Dashboard Template"
        description="This is React.js Videos page for SIMAK - React.js Tailwind CSS Admin Dashboard Template"
      />
