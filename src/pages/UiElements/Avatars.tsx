...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | SIMAK - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for SIMAK - React.js Tailwind CSS Admin Dashboard Template"
      />
